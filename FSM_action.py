...
def ChoosingCardAction():
    ...
    while True:
        ...
        if loop_count >= 60:
            ...
            return FSM_ERROR
        time.sleep(STATE_CHECK_INTERVAL+random.random()+random.random()+random.random()+random.random()+random.random())
...
def Battling():
    ...
    while True:
        ...
        if mine_count >= 20:
            ...
            click.commit_error_report()
            click.cancel_click()
            time.sleep(STATE_CHECK_INTERVAL+random.random())
        ...
        if my_index != -2:
            ...
            click.end_turn()
            time.sleep(STATE_CHECK_INTERVAL+random.random()+random.random())
